# MLB
MLB(aka machine learning benchmark) is a toolkit, that allows to conviniently benchmark various machine learning methods on different data modalities. 
...
```python
from src.mlb.api import MLBenchmark
